    ...
    <div class="wrapper">
      ...
      <div class="grid">
        ...
        <div class="col-1-3">
          ...
          <p>General donations to support Curing Kids Cancer's mission of finding cures for childhood cancers in our lifetime.</p>
          <p><a href="" class="btn">Donate Now</a></p>
        </div>

        <div class="col-1-3">
          <h2>In Memory or Honor Donations</h2>
          <p>Donations in honor or memory of a special person or event.</p>
          <p><a href="" class="btn">Donate Now</a></p>
        </div>

        <div class="col-1-3">
          <h2>Support a Fundraiser</h2>
          <p>Join Craig Kimbrel and other fundraisers, in Curing Kids Cancer.</p>
          <p><a href="" class="btn">Donate Now</a></p>
        </div>
